...
ActiveRecord::Schema.define(version: 2018_11_03_143740) do
  ...
  create_table "messengers", id: :serial, force: :cascade do |t|
    t.string "user"
    t.text "comment"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "products", id: :serial, force: :cascade do |t|
    ...
    t.string "yahoo_url"
    t.string "amazon_url"
    t.index ["user", "asin"], name: "for_upsert", unique: true
